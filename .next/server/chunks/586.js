...
function createCollection(name) {
  ...
  const CollectionSlotImpl = (0,react_slot_dist/* createSlot */.Z8)(COLLECTION_SLOT_NAME);
  const CollectionSlot = react_.forwardRef(
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0,jsx_runtime_.jsx)(CollectionSlotImpl, { ref: composedRefs, children });
    }
  );
  CollectionSlot.displayName = COLLECTION_SLOT_NAME;
  const ITEM_SLOT_NAME = name + "CollectionItemSlot";
  const ITEM_DATA_ATTR = "data-radix-collection-item";
  const CollectionItemSlotImpl = (0,react_slot_dist/* createSlot */.Z8)(ITEM_SLOT_NAME);
  const CollectionItemSlot = react_.forwardRef(
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0,jsx_runtime_.jsx)(CollectionItemSlotImpl, { ...{ [ITEM_DATA_ATTR]: "" }, ref: composedRefs, children });
    }
  );
...
function useCallbackRef(callback) {
  const callbackRef = react_.useRef(callback);
  react_.useEffect(() => {
    callbackRef.current = callback;
  });
  return react_.useMemo(() => (...args) => callbackRef.current?.(...args), []);
}
...
var FocusScope = react_.forwardRef((props, forwardedRef) => {
  const {
    loop = false,
    trapped = false,
  ...
  const [container, setContainer] = react_.useState(null);
  const onMountAutoFocus = useCallbackRef(onMountAutoFocusProp);
  const onUnmountAutoFocus = useCallbackRef(onUnmountAutoFocusProp);
  const lastFocusedElementRef = react_.useRef(null);
  const composedRefs = (0,dist/* useComposedRefs */.e)(forwardedRef, (node) => setContainer(node));
  const focusScope = react_.useRef({
    paused: false,
    pause() {
      this.paused = true;
    },
  ...
  const handleKeyDown = react_.useCallback(
    (event) => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime_.jsx)(react_primitive_dist/* Primitive */.WV.div, { tabIndex: -1, ...scopeProps, ref: composedRefs, onKeyDown: handleKeyDown });
});
...
var dist_Root = (/* unused pure expression or super */ null && (FocusScope));
...
var useLayoutEffect2 = globalThis?.document ? react_.useLayoutEffect : () => {
};
...
function useId(deterministicId) {
  const [id, setId] = react_.useState(useReactId());
  useLayoutEffect2(() => {
...
var Portal = react_.forwardRef((props, forwardedRef) => {
  const { container: containerProp, ...portalProps } = props;
  const [mounted, setMounted] = react_.useState(false);
  useLayoutEffect2(() => setMounted(true), []);
  const container = containerProp || mounted && globalThis?.document?.body;
  return container ? server_rendering_stub_.createPortal(/* @__PURE__ */ (0,jsx_runtime_.jsx)(react_primitive_dist/* Primitive */.WV.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
function useControllableState({
  ...
  if (true) {
    const isControlledRef = react_.useRef(prop !== void 0);
    react_.useEffect(() => {
...
function useUncontrolledState({
  ...
  const [value, setValue] = react_.useState(defaultProp);
  const prevValueRef = react_.useRef(value);
  const onChangeRef = react_.useRef(onChange);
  useInsertionEffect(() => {
...
var Select = (props) => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime_.jsx)(Root2, { ...popperScope, children: /* @__PURE__ */ (0,jsx_runtime_.jsxs)(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
...
var SelectTrigger = react_.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = (0,dist/* useComposedRefs */.e)(forwardedRef, context.onTriggerChange);
    ...
    return /* @__PURE__ */ (0,jsx_runtime_.jsx)(Anchor, { asChild: true, ...popperScope, children: /* @__PURE__ */ (0,jsx_runtime_.jsx)(
...
var SelectValue = react_.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = (0,dist/* useComposedRefs */.e)(forwardedRef, context.onValueNodeChange);
    useLayoutEffect2(() => {
...
var SelectPortal = (props) => {
  return /* @__PURE__ */ (0,jsx_runtime_.jsx)(Portal, { asChild: true, ...props });
};
...
var SelectViewport = react_.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = (0,dist/* useComposedRefs */.e)(forwardedRef, contentContext.onViewportChange);
...
var SelectItem = react_.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = (0,dist/* useComposedRefs */.e)(
      forwardedRef,
...
var SelectScrollUpButton = react_.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = (0,dist/* useComposedRefs */.e)(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
...
var SelectArrow = react_.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.open && contentContext.position === "popper" ? /* @__PURE__ */ (0,jsx_runtime_.jsx)(dist_Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
