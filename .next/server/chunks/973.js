...
module.exports = createProxy("C:\\Users\\hasan\\Downloads\\Quickeats\\node_modules\\next\\dist\\client\\components\\app-router.js");
 //# sourceMappingURL=app-router.js.map
...
// UNUSED EXPORTS: Root, Slottable, createSlot, createSlottable
...
function createSlot(ownerName) {
  ...
  const Slot2 = react_.forwardRef((props, forwardedRef) => {
...
function createSlotClone(ownerName) {
  const SlotClone = react_.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (react_.isValidElement(children)) {
      const childrenRef = getElementRef(children);
      const props2 = mergeProps(slotProps, children.props);
      if (children.type !== react_.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return react_.cloneElement(children, props2);
    }
...
function isSlottable(child) {
  return react_.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER;
}
