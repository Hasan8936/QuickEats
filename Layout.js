...
const navigationItems = [
  { title: "Order Food", url: createPageUrl("CustomerOrders"), icon: ShoppingBag },
  { title: "Partners", url: createPageUrl("DeliveryPartners"), icon: Users },
  { title: "Pricing Control", url: createPageUrl("SurgeControl"), icon: TrendingUp },
  { title: "Analytics", url: createPageUrl("LiveAnalytics"), icon: BarChart3 },
];
...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Header */}
      <header className="bg-gradient-to-r from-orange-500 to-red-500 shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <Link to={createPageUrl("CustomerOrders")} className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-gradient-to-r from-orange-500 to-red-500 rounded-xl flex items-center justify-center">
                  <ShoppingBag className="w-6 h-6 text-white" />
                </div>
                <div>
                  <h1 className="text-2xl font-bold text-white">QuickEats</h1>
                  <p className="text-xs text-orange-100 font-medium">Dynamic Pricing System</p>
                </div>
              </Link>
            </div>
                ...
                <Link
                  ...
                  className={`flex items-center space-x-2 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                    location.pathname === item.url
                      ...
                      : "text-white hover:text-orange-100 hover:bg-orange-600/10"
                  }`}
                >
            ...
            <div className="md:hidden">
              <button
                ...
                className="p-2 rounded-md text-white hover:text-orange-100 hover:bg-orange-600/10 transition-colors"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-300 mb-4 max-w-md">
                Revolutionary food delivery platform with intelligent surge pricing technology that adapts to
                real-time demand and supply across Lucknow.
              </p>
              <div className="space-y-2">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-sm text-gray-400">©2024 QuickEats. All rights reserved. Built with dynamic surge pricing technology.</p>
